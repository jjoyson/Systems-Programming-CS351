...
size_t min_class_size[] = {MIN_BLK_SIZE, 40 /* FOR SMALLEST BLOCK + PAYLOAD */, 64 + MIN_BLK_SIZE ,128 + MIN_BLK_SIZE ,256 + MIN_BLK_SIZE ,1024 + MIN_BLK_SIZE};
